...
public enum ErrorCode {
  ...
  INVALID_INPUT_USERNAME_SIZE("아이디는 5자 이상 20 이하여야 합니다", HttpStatus.BAD_REQUEST),
  INVALID_INPUT_PASSWORD_SIZE("비밀번호는 5자 이상 50 이하여야 합니다", HttpStatus.BAD_REQUEST),
  INVALID_INPUT_NICKNAME_SIZE("닉네임은 3자 이상 50 이하여야 합니다", HttpStatus.BAD_REQUEST),
